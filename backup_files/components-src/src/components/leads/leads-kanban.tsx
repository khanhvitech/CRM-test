...
const sampleLeads: Lead[] = [  {
    ...
    region: "Đà Nẵng",
    product: "Dịch vụ Z",
    content: "Yêu cầu báo giá chi tiết",
    tags: ["high"],
    ...
    region: "Hải Phòng",
    product: "Dịch vụ Premium",
    content: "Yêu cầu mở rộng dịch vụ",
    tags: ["enterprise", "high"],
    ...
    region: "Cần Thơ",
    product: "Dịch vụ Standard",
    content: "Ký hợp đồng dịch vụ",
    tags: ["closed", "success"],
